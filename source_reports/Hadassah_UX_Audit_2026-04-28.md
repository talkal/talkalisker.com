...
```pagezone
Zone: Hero | Type: Hero
כותרת בשפת המטופל: "מומחים להחזיר תנועה חלקה לכתף שלך." שם יחידת הכתף של הדסה + שיוך לבית החולים כעוגן אמון משני. תיאור יחידה במשפט אחד. CTA ראשי יחיד: "תאמו פגישת ייעוץ" — גלוי מעל הקפל בכל המכשירים.
