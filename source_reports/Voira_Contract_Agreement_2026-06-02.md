...
**Term:** The project will run as a compressed 5-week sprint with weekly milestone reviews. Tal handles technical architecture and copywriting; Yaeli handles visual identity.
:::

:::es
# 02. /terminos_del_acuerdo
...
**Término:** El proyecto se ejecutará como un sprint comprimido de 5 semanas con revisiones de hitos semanales. Tal maneja la arquitectura técnica y el copywriting; Yaeli maneja la identidad visual.
:::

:::en
# 03. /project_roadmap

This schedule dictates the delivery of project milestones.

**Phase 1: Brand Foundation & Strategic Naming (June 1–7)**
Delivery of naming candidates, target audience definition, and brand voice. Includes presentation of two distinct brand/naming directions for strategic choice.

**Phase 2: Full Brand Kit & Visual Identity (June 8–21)**
Delivery of the complete branding kit for the chosen direction, including logo suite, color palette, typography system, visual language, and comprehensive brand guidelines. 

**Phase 3: Web Development & Brand Applications (June 22–28)**
...
:::es
# 03. /cronograma_del_proyecto

Este cronograma dicta la entrega de los hitos del proyecto.

**Fase 1: Base de Marca y Naming Estratégico (1–7 de junio)**
Entrega de candidatos de nombres, definición del público objetivo y voz de marca. Incluye la presentación de dos direcciones de marca/naming distintas para la elección estratégica.

**Fase 2: Kit de Marca Completo e Identidad Visual (8–21 de junio)**
Entrega del kit de marca completo para la dirección elegida, incluyendo suite de logotipos, paleta de colores, sistema tipográfico, lenguaje visual y directrices de marca.

**Fase 3: Desarrollo Web y Aplicaciones de Marca (22–28 de junio)**
...
This contract confirms the fixed investment and milestone payment triggers.

- **Metric:** Total Investment | **Value:** €2,700 | **Trend:** Fixed
- **Metric:** Payment 1 — Project Start & Discovery (33%) | **Value:** €900 | **Trend:** Due upfront
- **Metric:** Payment 2 — Major Deliverables & Web Dev (33%) | **Value:** €900 | **Trend:** On Phase 3 delivery
- **Metric:** Payment 3 — Final Approval & Handover (33%) | **Value:** €900 | **Trend:** On Phase 4 completion

*All payments are final upon delivery of the associated milestone. There are no recurring subscriptions or hosting fees.*
:::

:::es
# 04. /calendario_de_pagos

Este contrato confirma la inversión fija y los activadores de pago por hitos.
...
- **Métrica:** Pago 2 — Entregables Principales y Desarrollo Web (33%) | **Valor:** €900 | **Tendencia:** A la entrega de la Fase 3
- **Métrica:** Pago 3 — Aprobación Final y Entrega (33%) | **Valor:** €900 | **Tendencia:** Al finalizar la Fase 4

*Todos los pagos son definitivos a la entrega del hito asociado. No hay suscripciones recurrentes ni tarifas de alojamiento.*
:::
